<div class="modal fade modal_excluir" id="modal_excluir" tabindex="-1" aria-labelledby="modal_excluirLabel" aria-hidden="true">
...
<div class="modal fade modal_restaurar" id="modal_restaurar" tabindex="-1" aria-labelledby="modal_restaurarLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div style="display: flex; justify-content: center;padding: 20px;flex-direction: column;">
                <div style="display: flex;justify-content: center;">
                ...
                <div style="display: flex;justify-content: center;" class="gap-2">
                    <button type="button" class="btn btn-primary mr-2" data-bs-dismiss="modal">Cancelar</button>
