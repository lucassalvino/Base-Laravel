...
$(document).ready(function () {
    $(".user-menu .dropdown-toggle").on("click", function(){
        var btn = $(".user-menu .dropdown-toggle");
        var menu = $(".user-menu .dropdown-menu");
    ...
    if($(".mask-money").length){
        $.each($(".mask-money"), function (i, o) {
            ...
            $(this).maskMoney({ suffix: suffix, decimal: ",", thousands: ".", allowNegative: permitirNegativo });
        });
    }
